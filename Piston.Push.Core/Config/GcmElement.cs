...
{
    public class GcmElement : ConfigurationElement, IAgentSettings
    {
        [ConfigurationProperty("sendUrl", DefaultValue = "https://android.googleapis.com/gcm/send")]
        public string SendUrl
        {
            get { return (string)this["sendUrl"]; }
